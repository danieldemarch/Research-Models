...
inm = Input(shape = (167,))
xm = Dense(168, activation = 'relu')(inm)
xm = keras.layers.Dropout(rate = .5)(xm)
xm = Dense(21, activation = 'relu')(xm)
xm = keras.layers.Dropout(rate = .5)(xm)
xm = Dense(168, activation = 'relu')(xm)
xm = keras.layers.Dropout(rate = .5)(xm)
outm = Dense(1, activation = 'sigmoid')(xm)


inf = Input(shape = (2048,))
xf = Dense(1000, activation = 'relu')(inf)
xf = keras.layers.Dropout(rate = .5)(xf)
xf = Dense(50, activation = 'relu')(xf)
xf = keras.layers.Dropout(rate = .5)(xf)
xf = Dense(1000, activation = 'relu')(xf)
xf = keras.layers.Dropout(rate = .5)(xf)
